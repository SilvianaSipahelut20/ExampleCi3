...
<div class="tabbable" style="background: bluesky; border-radius:6px; padding: 2px;"> <!-- Only required for left/right tabs -->
  ...
  <div class="tab-content" style="padding: 5px;">
    <div class="tab-pane active" id="tab1">
      ...
      <div class="hero-unit">
        ...
        <p>Selamat datang di program administrasi perpustakaan Rumah Terang</p>
        <p>
