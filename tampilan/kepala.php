...
<html lang="en">
<head>
    <title>Perpustakaan RUMAH TERANG <?php echo getVersion(); ?></title>
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    ...
    <ul class="nav">
        ...
        <li class="divider-vertical"></li>
        <li class="dropdown">
            <a href='#' class="dropdown-toggle" role="button" data-toggle="dropdown" data-target="#" title='Daftar Pinjaman'><i class="  icon-th-list"></i> <b>Option</b> <b class="caret"></b></a>
