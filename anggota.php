...
<h2 style="border-bottom: 1px solid #e2d9d9">Data Peminjam</h2>
    ...
    <tr>
        <td colspan='6'>
            ...
            <form class="hide" id="form-add" action='' method='post' name='frm-tambah' style='margin-top: 5px;'>
                ...
                <input type='text' name='nama' title='Nama Peminjam' disabled='disabled' placeholder="Nama Siswa"><br>
        ...
        <td colspan='6'>
            <form action='' method='get' name='cari'>
                ...
                <select name='jurusan' onchange='submiter()'>
                    <option value=''>Semua</option>
                    <optgroup label='Jurusan'>
                        <option value='IPA' <?php if($jur=='IPA') echo "selected='selected'"; ?>>IPA</option>
                        <option value='IPS' <?php if($jur=='IPS') echo "selected='selected'"; ?>>IPS</option>
                        <option value='BAHASA' <?php if($jur=='BAHASA') echo "selected='selected'"; ?>>BAHASA</option>
                    </optgroup>
                </select>
